...
public class FindElements_Method {
	...
	//chrome browser extension
		...
		List<WebElement>listofInputTagNamesElements=driver.findElements(By.tagName("div"));
		
		System.out.println("listofInputTagNames is :"+listofInputTagNamesElements.size());
