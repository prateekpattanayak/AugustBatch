...
List<WebElement>parent=driver.findElements(By.xpath("//span[text()='Women Ethnic']//parent::div"));
		
		System.out.println("Total number of parent webelements in a webpage is :"+parent.size());
