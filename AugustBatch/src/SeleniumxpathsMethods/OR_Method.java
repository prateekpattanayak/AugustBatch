...
System.out.println(driver.getCurrentUrl());
	...
	List<WebElement>lists=driver.findElements(By.xpath("//span[@color='greyBase' or text()='Women Ethnic']"));
		
		System.out.println("Total number of webelements in a webpage is :"+lists.size());
